...
execute as @s[name="Block of Coal"] run function eborders:bp/conversion/coal_block
execute as @s[name="Block of Amethyst"] run function eborders:bp/conversion/amethyst_block
execute as @s[name="Block of Diamond"] run function eborders:bp/conversion/diamond_block
...
execute as @s[name="Smooth Quartz Block"] run function eborders:bp/conversion/smooth_quartz
...
execute as @s[name="Hay Bale"] run function eborders:bp/conversion/hay_block
...
execute as @s[name="Block of Redstone"] run function eborders:bp/conversion/redstone_block
execute as @s[name="Redstone Repeater"] run function eborders:bp/conversion/repeater
execute as @s[name="Redstone Comparator"] run function eborders:bp/conversion/comparator
...
execute as @s[name="Raw Salmon"] run function eborders:bp/conversion/salmon
...
execute as @s[name="Eye of Ender"] run function eborders:bp/conversion/ender_eye
...
execute as @s[name="Raw Rabbit"] run function eborders:bp/conversion/rabbit
execute as @s[name="Cooked Rabbit"] run function eborders:bp/conversion/cooked_rabbit
execute as @s[name="Rabbit's Foot"] run function eborders:bp/conversion/rabbit_foot
execute as @s[name="Rabbit Hide"] run function eborders:bp/conversion/rabbit_hide
execute as @s[name="Raw Mutton"] run function eborders:bp/conversion/mutton
