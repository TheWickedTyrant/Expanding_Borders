...
execute as @s[name="Block of Netherite"] run function eborders:bp/conversion/block_of_netherite
...
execute as @s[name="Waxed Block of Copper"] run function eborders:bp/conversion/waxed_block_of_copper
...
execute as @s[name="Block of Quartz"] run function eborders:bp/conversion/block_of_quartz
...
execute as @s[name="Minecart with Chest"] run function eborders:bp/conversion/minecart_with_chest
execute as @s[name="Minecart with Furnace"] run function eborders:bp/conversion/minecart_with_furnace
execute as @s[name="Minecart with TNT"] run function eborders:bp/conversion/minecart_with_tnt
...
execute as @s[name="Oak Boat with Chest"] run function eborders:bp/conversion/oak_boat_with_chest
execute as @s[name="Spruce Boat"] run function eborders:bp/conversion/spruce_boat
execute as @s[name="Spruce Boat with Chest"] run function eborders:bp/conversion/spruce_boat_with_chest
execute as @s[name="Birch Boat"] run function eborders:bp/conversion/birch_boat
execute as @s[name="Birch Boat with Chest"] run function eborders:bp/conversion/birch_boat_with_chest
execute as @s[name="Jungle Boat"] run function eborders:bp/conversion/jungle_boat
execute as @s[name="Jungle Boat with Chest"] run function eborders:bp/conversion/jungle_boat_with_chest
execute as @s[name="Acacia Boat"] run function eborders:bp/conversion/acacia_boat
execute as @s[name="Acacia Boat with Chest"] run function eborders:bp/conversion/acacia_boat_with_chest
execute as @s[name="Dark Oak Boat"] run function eborders:bp/conversion/dark_oak_boat
execute as @s[name="Dark Oak Boat with Chest"] run function eborders:bp/conversion/dark_oak_boat_with_chest
execute as @s[name="Mangrove Boat"] run function eborders:bp/conversion/mangrove_boat
execute as @s[name="Mangrove Boat with Chest"] run function eborders:bp/conversion/mangrove_boat_with_chest
execute as @s[name="Turtle Shell"] run function eborders:bp/conversion/turtle_shell
...
execute as @s[name="Map"] run function eborders:bp/conversion/map
...
execute as @s[name="Bottle o' Enchanting"] run function eborders:bp/conversion/bottle_o_enchanting
...
execute as @s[name="Empty Map"] run function eborders:bp/conversion/empty_map
