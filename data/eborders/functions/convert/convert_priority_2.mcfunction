...
execute as @s[name="Block of Raw Iron"] run function eborders:bp/conversion/block_of_raw_iron
execute as @s[name="Block of Raw Copper"] run function eborders:bp/conversion/block_of_raw_copper
execute as @s[name="Block of Raw Gold"] run function eborders:bp/conversion/block_of_raw_gold
execute as @s[name="Block of Iron"] run function eborders:bp/conversion/block_of_iron
execute as @s[name="Block of Copper"] run function eborders:bp/conversion/block_of_copper
execute as @s[name="Block of Gold"] run function eborders:bp/conversion/block_of_gold
...
execute as @s[name="Block of Lapis Lazuli"] run function eborders:bp/conversion/block_of_lapis_lazuli
...
execute as @s[name="Redstone Dust"] run function eborders:bp/conversion/redstone_dust
...
execute as @s[name="Nether Quartz"] run function eborders:bp/conversion/nether_quartz
...
execute as @s[name="Raw Porkchop"] run function eborders:bp/conversion/raw_porkchop
...
execute as @s[name="Steak"] run function eborders:bp/conversion/steak
execute as @s[name="Raw Chicken"] run function eborders:bp/conversion/raw_chicken
