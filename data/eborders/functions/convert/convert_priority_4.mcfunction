...
execute as @s[name="Lapis Lazuli Ore"] run function eborders:bp/conversion/lapis_ore
execute as @s[name="Deepslate Lapis Lazuli Ore"] run function eborders:bp/conversion/deepslate_lapis_ore
...
execute as @s[name="Jack o'Lantern"] run function eborders:bp/conversion/jack_o_lantern
...
execute as @s[name="Vines"] run function eborders:bp/conversion/vine
...
execute as @s[name="Block of Emerald"] run function eborders:bp/conversion/emerald_block
...
execute as @s[name="Minecart with Hopper"] run function eborders:bp/conversion/hopper_minecart
...
execute as @s[name="Leather Cap"] run function eborders:bp/conversion/leather_helmet
execute as @s[name="Leather Tunic"] run function eborders:bp/conversion/leather_chestplate
execute as @s[name="Leather Pants"] run function eborders:bp/conversion/leather_leggings
...
execute as @s[name="Bucket of Pufferfish"] run function eborders:bp/conversion/pufferfish_bucket
execute as @s[name="Bucket of Salmon"] run function eborders:bp/conversion/salmon_bucket
execute as @s[name="Bucket of Cod"] run function eborders:bp/conversion/cod_bucket
execute as @s[name="Bucket of Tropical Fish"] run function eborders:bp/conversion/tropical_fish_bucket
execute as @s[name="Bucket of Axolotl"] run function eborders:bp/conversion/axolotl_bucket
execute as @s[name="Bucket of Tadpole"] run function eborders:bp/conversion/tadpole_bucket
...
execute as @s[name="Disc Fragment"] run function eborders:bp/conversion/disc_fragment_5
