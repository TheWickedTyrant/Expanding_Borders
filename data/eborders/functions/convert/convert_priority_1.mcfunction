...
execute as @s[name="Slimeball"] run function eborders:bp/conversion/slime_ball
execute as @s[name="Egg"] run function eborders:bp/conversion/egg
execute as @s[name="Raw Cod"] run function eborders:bp/conversion/cod
...
execute as @s[name="Raw Beef"] run function eborders:bp/conversion/beef
